...
const checkOrdersProperties = async (orders, limiter) => {
  console.log(`Checking ${orders.length} order properties`);

  // Extract all planner group options across all orders
  const plannerGroupOptions = orders.map(
